...
class LockStatusTest extends TestCase
{
    ...
    public function testLockStatus()
    {
        ...
        $this->assertCount(1, \App\ContentLock::all());
    }
    ...
    private function setUpVersioningClient()
    {
        ...
        $versionData = (new \Cerpus\VersionClient\VersionData())->populate($versionResponse->data);
