...
class H5PCopyrightTest extends TestCase
{
    ...
    public function imageWithLicense_useCopyright()
    {
        ...
        $expectedCopyright = H5PCopyrightDataObject::create([
            ...
            'contentType' => "Image",
            'thumbnail' => 'https://cdn.example.net/content/' . $h5pContent->id . '/images/image-5c6e5e7364254.jpg',
        ]);
        $this->assertEquals([
            'h5p' => null,
            'h5pLibrary' => null,
    ...
    public function imageWithLicense_useMetadata()
    {
        ...
        $expectedImageCopyright = H5PCopyrightDataObject::create([
            ...
            'thumbnail' => 'https://cdn.example.net/content/' . $h5pContent->id . '/images/backgroundimage.jpg',
            'contentType' => 'Image',
        ])->toArray();
    ...
    public function imageAndText_withLicense_useCopyrightAndMetadata()
    {
        ...
        $expectedBackgroundImageCopyright = H5PCopyrightDataObject::create([
            ...
            'contentType' => 'Image',
            'thumbnail' => 'https://cdn.example.net/content/' . $h5pContent->id . '/images/einstein.jpg'
        ])->toArray();
        ...
        $expectedImageCopyright = H5PCopyrightDataObject::create([
            ...
            'thumbnail' => 'https://cdn.example.net/content/' . $h5pContent->id . '/images/monalisa.jpg',
            'contentType' => 'Image',
        ])->toArray();
    ...
    public function cerpusImageWithLicense_useMetadata()
    {
        ...
        $expectedCopyright = H5PCopyrightDataObject::create([
            ...
            'licenseVersion' => "4.0",
            'contentType' => 'Image',
            'thumbnail' => sprintf('https://cdn.example.net/content/%s/images/testimage.jpg', $h5pContent->id),
        ])->toArray();
