...
class ArticleController extends Controller
{
    ...
    public function store(ArticleRequest $request): JsonResponse
    {
        ...
        event(new ArticleWasSaved($article, $request, Session::get('authId'), ContentVersion::PURPOSE_CREATE, Session::all()));
    ...
    public function update(ArticleRequest $request, Article $article)
    {
        ...
        event(new ArticleWasSaved($article, $request, Session::get('authId'), ContentVersion::PURPOSE_COPY, Session::all()));
