...
class NDLAH5PAdapter implements H5PAdapterInterface
{
    ...
    {
        return [
            'wirisPath' => request()->root() . '/js/h5p/ckeditor_wiris/plugin.js',
        ];
    }
    ...
    {
        $scripts = [
            '//cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.9/MathJax.js?config=TeX-AMS-MML_HTMLorMML',
