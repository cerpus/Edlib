...
return [
    "1.0 Generic" => "1.0 Generisk",
    "2.0 Generic" => "2.0 Generisk",
    "2.5 Generic" => "2.5 Generisk",
    ...
    "Retry now" => "Prøv om att no",
    "Retrying in :num...." => "Forsøkjer om :num…",
    "Reuse Content" => "Gjenbruk innhald",
    "Reuse this content." => "Gjenbruk dette innhaldet.",
    "Reuse" => "Gjenbruk",
    ...
    "Source" => "Kjelde",
    "Sublevel" => "Undernivå",
    "Successfully submitted results." => "Resultata vart leverte.",

    "This content has changed since you last used it." => "Dette innhaldet har blitt endra sidan du brukte det sist.",
    "Thumbnail" => "Miniatyrbilete",
    "Title" => "Tittel",

    "Undisclosed" => "Ikkje oppgjeve",

    "Version 1" => "Versjon 1",
    "Version 2" => "Versjon 2",
    "Version 3" => "Versjon 3",
    "View copyright information for this content." => "Vis informasjon om opphavsrett for dette innhaldet.",
    "View the embed code for this content." => "Vis koden for inkorporering av dette innhaldet.",
    "Visit H5P.org to check out more cool content." => "Besøk H5P.org for å sjå meir stilig innhald.",
