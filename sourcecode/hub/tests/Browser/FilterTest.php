...
final class FilterTest extends DuskTestCase
{
    public function testCanToggleFilter(): void
    {
        $this->browse(fn (Browser $browser) => $browser
            ->visit('/content')
            ->with(new FilterForm(), fn ($filter) => $filter
                ->assertCollapsed()
                ->expand()
                ->assertExpanded()
                ->collapse()
    ...
    public function testCanSearch(): void
    {
        ...
        $this->browse(fn (Browser $browser) => $browser
            ...
            ->with(new ContentCard(), fn ($card) => $card
    ...
    public function testCanFilterOnContentType(): void
    {
        ...
        $this->browse(fn (Browser $browser) => $browser
            ...
            ->with(new FilterForm(), fn ($filter) => $filter
                ->expand()
                ->withContentTypeFilter(fn ($typeFilter) => $typeFilter
    ...
    public function testCanFilterOnLanguage(): void
    {
        ...
        $this->browse(fn (Browser $browser) => $browser
            ...
            ->with(new FilterForm(), fn ($filter) => $filter
                ->expand()
                ->withLanguageFilter(fn ($langFilter) => $langFilter
    ...
    public function testCanFilterLanguageOptions(): void
    {
        ...
        $this->browse(fn (Browser $browser) => $browser
            ...
            ->with(new FilterForm(), fn ($filter) => $filter
                ->expand()
                ->withLanguageFilter(fn ($choice) => $choice
                    ->assertHasOption('nob')
                    ->assertHasOption('eng')
    ...
    public function testCanSort(): void
    {
        ...
        $this->browse(fn (Browser $browser) => $browser->visit('/content')
            ->assertSee('2 contents found')
            ->with(new ContentCard(), fn ($card) => $card
