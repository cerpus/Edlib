...
:::note 
We are continuously trying to improve Edlib and its documentation. Please create an [issue](https://github.com/cerpus/Edlib/issues) if you have any suggstions for improvement or, alternatively, fix the issue yourself and submit a [Pull Request](http://localhost:3000/docs/community/contributing). It's great to have you aboard :wink:
:::
