...
Cerpus welcomes contributions to our [open source projects on Github](https://github.com/cerpus/Edlib). When contributing, please follow the [Cerpus Community Code of Conduct](https://github.com/cerpus/Edlib/blob/master/CODE_OF_CONDUCT.md).
...
## Translations
Translating Edlib is an excellent way of contributing to the project. Translations enable multilingual usage and a better product for all users. Go to our section about [translating Edlib](https://docs.edlib.com/docs/developers/translation) and learn how to do it. 
