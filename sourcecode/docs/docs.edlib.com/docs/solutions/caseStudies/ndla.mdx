...
The creation of resources starts at the "Create Content" in Edlib's header bar. This brings the user to the H5P Hub where the preview and the supported H5P types are listed.
