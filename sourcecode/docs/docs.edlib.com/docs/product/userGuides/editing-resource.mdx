...
This article will assume that you have already created a resource. See our article on [creating content](create-content.mdx) if you haven't created the resource yet.

:::

## How to open the editor

You can edit all the resources found in [My content](my-content.mdx) or [Shared content](shared-content.mdx) by clicking on the resource you want to edit and clicking **Edit resource**.  
