...
For a thorough explanation for how to search for Edlib resources, see [Shared content](shared-content.mdx)
...
When you've finished previewing your resource, you can either use it as it is or [edit it first](editing-resource.mdx).