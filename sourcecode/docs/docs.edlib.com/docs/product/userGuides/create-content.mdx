...
<center><i> Starting from scratch: When you want to create your own content </i></center>
...
<center><i>Create your quiz or Millionaire game in a few simple steps! </i></center>
<br /><br />

Your question set can either become a regular quiz…

![Quiz](../../../static/img/create-content-quiz.png)<br />
...
You can create a text or article with the text editor. This is a simple HTML editor where you can add images, links, tables, etc.
