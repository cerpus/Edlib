...
The **Shared content** tab lists all the resources other users has chosen tho share with all other Edlib users. These resources can be freely used and adapted to your own content.
...
When you've found the resource you want to use, click on it to get a preview of the resource. Afterwards, you can either choose to edit it first, or use it as is. If you choose to edit the resource first, a copy of the resource will be saved in the **[My content](my-content.mdx)** tab.
