...
<div class="text--center">
    <img class="edlib-image" alt="Pending" src="/img/interactive-video2.png" />
    <br/>
...
<div class="text--center">
    <img class="edlib-image" alt="Pending" src="/img/interactive-video3.png" />
    <br/>
...
Press the Add interactions tab in the top of the editor. 
