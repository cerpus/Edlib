...
Open Educational Resources (OERs) are any type of educational material that is in the public domain. They are published under open licenses (for example, ) that specify how materials can be used, reused, adapted, shared and modified according to specific needs, all within the boundaries of copyright law. OERs can include textbooks, lecture notes, syllabi, assignments and tests.
...
An overview of Creative Commons licensing is currently being worked on. Check back for updates.
