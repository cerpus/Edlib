...
## Prioritized roadmap activities for Q3 and Q4 of 2024

1. Deploy of the new Edlib
	* Migrate existing instances
	* Remove old services
	* Update documentation
	* Update repo

2. Edlib developer platform
	* Documentation for creating content types for Edlib
	* Create SDKs for other languages (e.g. JS)

3. Weblate - move and add Edlib Hub components
...
## Prioritized roadmap activities for Q2 of 2024

1. Resume work on Doku - the Edlib article

2. Weblate - move and add Edlib Hub components

3. Add information about hosting and services
	* Add section for hosting options
	* Add section for other available services

4. Make Edlib become a developer platform
	* Documentation for creating content types for Edlib
	* Create SDKs for other languages (e.g. JS) 

5. Improve tests
	* Remove incorrect and useless tests
	* Add end-to-end test using Dusk for Content Author, containing PHP-unit tests with user stories
...
## Prioritized roadmap activities for Q1 of 2024

1. Edlib 3  
	* Deploy to master 
	* Remove old services from repo

2. Tests
	* Add code coverage to Edlib hub	 
	* Publish test reports from PHPUnit

3. Documentation
	* Update "Getting started" setup guide for local setup
	* Write generic setup guide for prod/server setup
	* Update architectual documentation
