...
* Set up your own **development environment** by following the instructions in our [getting started section](https://docs.edlib.com/docs/developers/getting-started) on Edlib docs.
